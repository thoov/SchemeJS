...
switch( act )
{
	...
	case 5:
	{
		 rval = createList(vstack[ vstack.length - 2 ]) 
	}
	break;
	case 6:
	{
		 rval = createDotList(vstack[ vstack.length - 4 ], vstack[ vstack.length - 2 ]); 
	}
	break;
	case 7:
	{
		 rval = arrayAppend(vstack[ vstack.length - 2 ], vstack[ vstack.length - 1 ]); 
	}
	break;
	case 8:
	{
	...
	case 9:
	{
		 rval = createItem( 'NUMBER', vstack[ vstack.length - 1 ]); 
	}
	break;
	case 10:
	{
		 rval = createItem( 'SYMBOL', vstack[ vstack.length - 1 ]); 
	}
	break;
	case 11:
	{
		 rval = createItem( 'STRING', vstack[ vstack.length - 1 ]); 
	}
	break;
}
